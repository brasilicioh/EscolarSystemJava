    ...
    while (!entrada.equals("4")) { // irá ficar executando enquanto o usuário não escolher sair
      ...
      switch (entrada) {
        case "1":
          ...
          while (!entradatwo.equals("5")) { // irá ficar executando enquanto o usuário não escolher voltar ao menu
                                            // principal
            System.out.println();
            ...
            switch (entradatwo) {
              ...
              case "4":
                ...
                if (index >= alunos.size() || index < 0) {
                  ...
                  switch (entradathree) {
                    case "1":
                      System.out.print("Escreva o novo nome do aluno: ");
                      scan.nextLine();
            ...
            switch (entradatwo) {
              ...
              case "4":
                ...
                if (index >= disciplinas.size() || index < 0) {
                  ...
                  switch (entradathree) {
                    case "1":
                      System.out.print("Escreva o novo nome da disciplina: ");
                      scan.nextLine();
          ...
          while (!entradatwo.equals("5")) { // irá ficar executando enquanto o usuário não escolher voltar ao menu
            ...
            switch (entradatwo) {
              ...
              case "1":
                ...
                System.out.println(
                    "Digite o numero e em seguida enter para adicionar a disciplina (0 para finalizar o processo ou um numero invalido para cancelar): ");
                index = scan.nextInt() - 1;
              ...
              case "4":
                ...
                if (index >= cursos.size() || index < 0) {
                  ...
                  switch (entradathree) {
                    case "1":
                      System.out.print("Escreva o novo nome do curso: ");
                      scan.nextLine();
                    ...
                    case "2":
                      System.out.print("Escreva o novo turno do curso: ");
                      scan.nextLine();
                    ...
                    case "3":
                      ...
                      if (indextwo == -1) {
                        ...
                        System.out
                            .println("Voce escreveu algum numero invalido para as disciplinas, voltando para menu");
                      }
                      break;
